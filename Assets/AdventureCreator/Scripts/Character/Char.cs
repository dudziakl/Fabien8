...
namespace AC
{
	...
	public class Char : MonoBehaviour
	{
		...
		/** If True, and the character has a Rigidbody2D component, then it will be manipulated in FixedUpdate, as opposed to the transform being manipulated in Update */
